...
class MultiStageModel(nn.Module):
    def __init__(self, mstcn_stages, mstcn_layers, mstcn_f_maps, mstcn_f_dim, out_features,
            mstcn_causal_conv=True, use_softmax=False):
        self.num_stages = mstcn_stages  # 4 #2
        self.num_layers = mstcn_layers  # 10  #5
        self.num_f_maps = mstcn_f_maps  # 64 #32
        self.dim = mstcn_f_dim  #2048 # 256
        self.num_classes = out_features  # 128
