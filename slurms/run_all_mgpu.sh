...
best_model_path=work_dirs/lg_${detector}/$(ls work_dirs/lg_${detector}/best_${dataset}* | tail -1)
...
# test
export CUDA_VISIBLE_DEVICES=0 && python $MMDETECTION/tools/test.py $cfg_dir/lg_ds_${detector}.py work_dirs/lg_${detector}/best_${dataset}/$(ls work_dirs/lg_${detector}/best_${dataset}) &
export CUDA_VISIBLE_DEVICES=1 && python $MMDETECTION/tools/test.py $cfg_dir/lg_ds_${detector}_no_recon.py work_dirs/lg_${detector}/best_${dataset}/$(ls work_dirs/lg_${detector}/best_${dataset}) &
wait
...
# test
export CUDA_VISIBLE_DEVICES=0 && python $MMDETECTION/tools/test.py $cfg_dir/dc_${detector}.py work_dirs/dc_${detector}/best_${dataset}/$(ls work_dirs/dc_${detector}/best_${dataset}) &
export CUDA_VISIBLE_DEVICES=1 && python $MMDETECTION/tools/test.py $cfg_dir/dc_${detector}_no_recon.py work_dirs/dc_${detector}/best_${dataset}/$(ls work_dirs/dc_${detector}/best_${dataset}) &
wait
...
# test
export CUDA_VISIBLE_DEVICES=0 && python $MMDETECTION/tools/test.py $base_cfg_dir/simple_cvs_classifier.py work_dirs/mt_${detector}/$(ls work_dirs/mt_${detector}/best_${dataset}) --work-dir ./work_dirs/mt_${detector} &
export CUDA_VISIBLE_DEVICES=1 && python $MMDETECTION/tools/test.py $base_cfg_dir/simple_cvs_classifier_with_recon.py work_dirs/mt_${detector}_with_recon/$(ls work_dirs/mt_${detector}_with_recon/best_${dataset}) --work-dir ./work_dirs/mt_${detector}_with_recon &
wait
