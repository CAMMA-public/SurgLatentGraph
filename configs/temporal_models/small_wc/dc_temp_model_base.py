...
train_evaluator = dict(
    outfile_prefix='./results/small_wc_preds/train/dc_temp',
)
val_evaluator = dict(
    outfile_prefix='./results/small_wc_preds/val/dc_temp',
)
test_evaluator = dict(
    outfile_prefix='./results/small_wc_preds/test/dc_temp',
)
