...
train_evaluator = dict(
    outfile_prefix='./results/sages_weighted_preds/train/sv2lstg',
)
val_evaluator = dict(
    outfile_prefix='./results/sages_weighted_preds/val/sv2lstg',
)
test_evaluator = dict(
    outfile_prefix='./results/sages_weighted_preds/test/sv2lstg',
)
