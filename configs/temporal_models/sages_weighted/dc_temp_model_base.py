...
train_evaluator = dict(
    outfile_prefix='./results/sages_weighted_preds/train/dc_temp',
)
val_evaluator = dict(
    outfile_prefix='./results/sages_weighted_preds/val/dc_temp',
)
test_evaluator = dict(
    outfile_prefix='./results/sages_weighted_preds/test/dc_temp',
)
