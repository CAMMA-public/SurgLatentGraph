...
_base_ = os.path.expandvars('$MMDETECTION/configs/_base_/datasets/coco_detection.py')

# Modify dataset related settings
data_root='data/endoscapes_mmdet'
metainfo = dict(
    classes=('cystic_plate', 'calot_triangle', 'cystic_artery', 'cystic_duct', 'gallbladder', 'tool'),
...
#test_evaluator = dict(ann_file=os.path.join(data_root, 'test/annotation_coco.json'))
