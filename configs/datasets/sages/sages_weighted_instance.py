...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root=data_root,
        metainfo=metainfo,
        ann_file='weighted_train/annotation_coco.json',
        data_prefix=dict(img='weighted_train/'),
...
val_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root=data_root,
        metainfo=metainfo,
        ann_file='weighted_val/annotation_coco.json',
        data_prefix=dict(img='weighted_val/'),
        pipeline=eval_pipeline))
...
test_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root=data_root,
        metainfo=metainfo,
        ann_file='weighted_test/annotation_coco.json',
        data_prefix=dict(img='weighted_test/'),
        pipeline=eval_pipeline))

# metric
val_evaluator = dict(ann_file=os.path.join(data_root, 'weighted_val/annotation_coco.json'), format_only=False,)
test_evaluator = dict(ann_file=os.path.join(data_root, 'weighted_test/annotation_coco.json'), format_only=False,)
