...
train_data_prefix = 'weighted_train'
val_data_prefix = 'weighted_val'
test_data_prefix = 'weighted_test'
...
train_dataloader=dict(
    ...
    dataset=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file='weighted_train/annotation_coco_vid.json',
...
val_dataloader=dict(
    ...
    dataset=dict(
        ...
        type=dataset_type,
        data_root=data_root,
        ann_file='weighted_val/annotation_coco_vid.json',
...
test_dataloader=dict(
    ...
    dataset=dict(
        ...
        type=dataset_type,
        data_root=data_root,
        ann_file='weighted_test/annotation_coco_vid.json',
