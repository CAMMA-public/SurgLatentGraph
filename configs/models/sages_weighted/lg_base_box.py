...
val_evaluator = dict(
    ...
    ann_file=os.path.join(data_root, 'weighted_val/annotation_coco.json'),
    metric=['bbox'],
...
test_evaluator = dict(
    ...
    ann_file=os.path.join(data_root, 'weighted_test/annotation_coco.json'),
    metric=['bbox'],
    use_pred_boxes_recon=False,
...
default_hooks = dict(
    checkpoint=dict(save_best='sages_weighted/bbox_mAP'),
)
