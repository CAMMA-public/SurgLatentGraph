...
custom_imports = dict(imports=orig_imports + ['model.deepcvs', 'evaluator.CocoMetricRGD', 'evaluator.CVSMetric',
    ...
    'visualizer.CVSVisualizer'], allow_failed_imports=False)
...
train_evaluator = dict(
    ...
    num_classes=3,
    prefix='sages',
    outfile_prefix='./results/sages_preds/train/deepcvs',
)
val_evaluator = dict(
    _delete_=True,
    type='CVSMetric',
    num_classes=3,
    prefix='sages',
    outfile_prefix='./results/sages_preds/val/deepcvs',
)
...
test_evaluator = dict(
    ...
    num_classes=3,
    prefix='sages',
    outfile_prefix='./results/sages_preds/test/deepcvs',
)
