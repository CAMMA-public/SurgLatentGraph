...
custom_imports = dict(imports=orig_imports + ['model.simple_cvs_predictor', 'evaluator.CocoMetricRGD',
    'model.predictor_heads.reconstruction', 'model.predictor_heads.modules.loss'], allow_failed_imports=False)
