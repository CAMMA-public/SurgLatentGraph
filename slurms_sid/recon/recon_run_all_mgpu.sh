...
export CUDA_VISIBLE_DEVICES=0 && \
	python ${MMDETECTION}/tools/train.py ${cfg_dir}/lg_ds_${detector}.py --work-dir  work_dirs/recon_lg_ds_${detector}_${dataset}_${dataset2} --cfg-options load_from=weights/${dataset}/lg_${detector}_no_recon.pth  && \
	# test on endoscapes
	cd configs/models/ && \
	./select_dataset.sh endoscapes && \
	cd ../.. && \
	python ${MMDETECTION}/tools/test.py ${cfg_dir}/lg_ds_${detector}.py $(ls work_dirs/recon_lg_ds_${detector}_${dataset}_${dataset2}/best_${dataset2}* | tail -1) --work-dir work_dirs/recon_lg_ds_${detector}_${dataset}_${dataset2}/endoscapes && \
	# test on wc
	cd configs/models/ && \
	./select_dataset.sh wc && \
	cd ../.. && \
	python ${MMDETECTION}/tools/test.py ${cfg_dir}/lg_ds_${detector}.py $(ls work_dirs/recon_lg_ds_${detector}_${dataset}_${dataset2}/best_${dataset2}* | tail -1) --work-dir work_dirs/recon_lg_ds_${detector}_${dataset}_${dataset2}/wc && \
	#copy everything back
	cp -r $JOBSCRATCH/latentgraph/work_dirs/recon_lg_ds_${detector}_${dataset}_${dataset2} $SCRATCH/sid/latentgraph/work_dirs/recon_lg_ds_${detector}_${dataset}_${dataset2} &
...
#wait
export CUDA_VISIBLE_DEVICES=1 && \
	python ${MMDETECTION}/tools/train.py ${base_cfg_dir}/simple_cvs_classifier_with_recon.py --work-dir work_dirs/recon_mt_${detector}_${dataset}_${dataset2} --cfg-options load_from=weights/${dataset}/lg_${detector}_no_recon_bb.pth && \
	## test on endoscapes
	cd configs/models/ && \
	./select_dataset.sh endoscapes && \
	cd ../.. && \
	python ${MMDETECTION}/tools/test.py ${base_cfg_dir}/simple_cvs_classifier_with_recon.py $(ls work_dirs/recon_mt_${detector}_${dataset}_${dataset2}/best_${dataset2}* | tail -1) --work-dir work_dirs/recon_mt_${detector}_${dataset}_${dataset2}/endoscapes && \
	## test on wc
	cd configs/models/ && \
	./select_dataset.sh wc && \
	cd ../.. && \
	python ${MMDETECTION}/tools/test.py ${base_cfg_dir}/simple_cvs_classifier_with_recon.py $(ls work_dirs/recon_mt_${detector}_${dataset}_${dataset2}/best_${dataset2}* | tail -1) --work-dir work_dirs/recon_mt_${detector}_${dataset}_${dataset2}/wc && \
       #copy everything back
        cp -r $JOBSCRATCH/latentgraph/work_dirs/recon_mt_${detector}_${dataset}_${dataset2} $SCRATCH/sid/latentgraph/work_dirs/recon_mt_${detector}_${dataset}_${dataset2} &	

################################################################################################################################################################################################################################################################
##RUN SIMPLE

export CUDA_VISIBLE_DEVICES=2 && \
        python ${MMDETECTION}/tools/train.py ${base_cfg_dir}/simple_cvs_classifier_with_recon.py --work-dir work_dirs/recon_simple_${detector}_${dataset}_${dataset2} --cfg-options load_from=weights/${dataset}/lg_${detector}_no_recon.pth && \
        ## test on endoscapes
        cd configs/models/ && \
        ./select_dataset.sh endoscapes && \
        cd ../.. && \
        python ${MMDETECTION}/tools/test.py ${base_cfg_dir}/simple_cvs_classifier_with_recon.py $(ls work_dirs/recon_simple_${detector}_${dataset}_${dataset2}/best_${dataset2}* | tail -1) --work-dir work_dirs/recon_simple_${detector}_${dataset}_${dataset2}/endoscapes && \
        ## test on wc
        cd configs/models/ && \
        ./select_dataset.sh wc && \
        cd ../.. && \
        python ${MMDETECTION}/tools/test.py ${base_cfg_dir}/simple_cvs_classifier_with_recon.py $(ls work_dirs/recon_simple_${detector}_${dataset}_${dataset2}/best_${dataset2}* | tail -1) --work-dir work_dirs/recon_simple_${detector}_${dataset}_${dataset2}/wc && \
       #copy everything back
        cp -r $JOBSCRATCH/latentgraph/work_dirs/recon_simple_${detector}_${dataset}_${dataset2} $SCRATCH/sid/latentgraph/work_dirs/recon_simple_${detector}_${dataset}_${dataset2} &
