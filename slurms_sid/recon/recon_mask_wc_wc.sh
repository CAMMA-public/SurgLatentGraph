...
#SBATCH -p gpu_p13
#SBATCH -J recon_mask_wc_wc
#SBATCH --error recon_mask_wc_wc_error.log
#SBATCH --output recon_mask_wc_wc.log
#SBATCH -A lbw@v100
#SBATCH -C v100-32g
...
./slurms_sid/recon/recon_run_all_mgpu.sh mask_rcnn wc wc
