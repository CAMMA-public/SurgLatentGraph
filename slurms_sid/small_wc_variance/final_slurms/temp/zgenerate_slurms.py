...
#models = ["lg_ds", "lg_ds_no_sem", "lg_ds_no_viz", "dc", "layout", "mt", "viz_sem_img", "viz_img", "sem_img", "sem"]
#models = ["simple"]
models = ["lg_ds", "lg_ds_no_sem", "lg_ds_no_viz"]
...
models = [ "viz_sem_img", "viz_img", "sem_img", "sem"]
datasets = ['endoscapes']
for detector in detectors:
    for model in models:
        for dataset1 in datasets:
