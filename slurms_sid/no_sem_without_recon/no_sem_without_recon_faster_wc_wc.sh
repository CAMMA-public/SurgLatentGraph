...
#SBATCH -p gpu_p13
#SBATCH -J faster_wc_wc
#SBATCH --error faster_wc_wc_error.log
#SBATCH --output faster_wc_wc.log
#SBATCH -A lbw@v100
#SBATCH -C v100-32g
...
./slurms_sid/no_sem_without_recon/run_all_mgpu.sh faster_rcnn wc wc
