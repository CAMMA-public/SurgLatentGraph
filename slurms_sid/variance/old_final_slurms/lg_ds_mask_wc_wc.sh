...
#SBATCH -p gpu_p13
#SBATCH -J lg_ds_mask_wc_wc
#SBATCH --error lg_ds_mask_wc_wc_error.log
#SBATCH --output lg_ds_mask_wc_wc.log
#SBATCH -A lbw@v100
#SBATCH -C v100-32g
...
./slurms_sid/variance/run_test.sh lg_ds mask_rcnn wc wc
